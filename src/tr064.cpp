...
void TR064::initServiceURLs() {
    ...
    //_services[0][0] = "urn:dslforum-org:service:X_VoIP:1";
    //_services[0][1] = "/upnp/control/x_voip";
...
bool TR064::action(const String& service, const String& act, String params[][2], int nParam,  const String& url) {
    ...
    deb_println("[TR064][action] with parameters, url: "+url, DEBUG_VERBOSE);
    String req[][2] = {{}};
...
bool TR064::action(const String& service, const String& act, String params[][2], int nParam, String (*req)[2], int nReq, const String& url) {
    deb_println("[TR064][action] with extraction, url: "+url, DEBUG_VERBOSE);
...
deb_println("[TR064][action_raw] url: "+url, DEBUG_VERBOSE);
